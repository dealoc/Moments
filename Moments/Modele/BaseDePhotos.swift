...
class BaseDePhotos {
    ...
    func touteLesPhotos() -> [Photo] {
        ...
        photos.append(Photo(image: #imageLiteral(resourceName: "mes apps"), nom: "Laure", desc: "Mes apps ;)"))
        ...
        photos.append(Photo(image: #imageLiteral(resourceName: "steve scrabble"), nom: "Tomothée", desc: "Steve J. était-il bon au scrabble ?"))
